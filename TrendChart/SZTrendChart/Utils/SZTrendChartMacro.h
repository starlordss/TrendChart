...
#ifndef SZTrendChartMacro_h
#define SZTrendChartMacro_h
...
//}
//
static inline void dispatch_after_on_main_queue(int64_t delayInSeconds, void (^block)(void)) {
